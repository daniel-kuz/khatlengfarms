  ...
  return (
    <header style={{ position: 'relative', minHeight: '56vh', display: 'flex', alignItems: 'flex-end', padding: 'clamp(72px,9vw,144px) clamp(24px,5vw,96px) 64px', color: 'var(--color-bone)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: 1320, margin: '0 auto', width: '100%' }}>
        <div className="numlabel hero-animate" style={{ color: 'var(--color-gold-soft)', marginBottom: 20 }}><span></span>OUR PRODUCTS</div>
        <h1 className="hero-animate-1" style={{ color: 'var(--color-bone)', maxWidth: '18ch', marginBottom: 20 }}>Four Income Streams. One Resilient Operation.</h1>
