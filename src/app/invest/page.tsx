  ...
  return (
    <header style={{ position: 'relative', minHeight: '56vh', display: 'flex', alignItems: 'flex-end', padding: 'clamp(72px,9vw,144px) clamp(24px,5vw,96px) 64px', color: 'var(--color-bone)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: 1320, margin: '0 auto', width: '100%' }}>
        <div className="numlabel hero-animate" style={{ color: 'var(--color-gold-soft)', marginBottom: 20 }}><span></span>INVEST</div>
        <h1 className="hero-animate-1" style={{ color: 'var(--color-bone)', maxWidth: '20ch', marginBottom: 20 }}>A De-Risked, Governance-Led Investment in South African Agriculture.</h1>
    ...
    <section className="section-pad" style={{ background: 'var(--color-bone-deep)' }}>
      <div className="container">
        <div style={{ maxWidth: 720, marginBottom: 'clamp(40px,5vw,64px)' }}>
          ...
          <p className="lede" style={{ marginTop: 16 }}>Loan terms: R2,000,000 at Prime âˆ’ 2% (9.25% p.a.) · Quarterly instalments · 17 quarters · Fully repaid: April 2031</p>
        </div>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
