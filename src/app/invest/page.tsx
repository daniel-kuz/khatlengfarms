  ...
  return (
    <header style={{ position: 'relative', minHeight: '56vh', display: 'flex', alignItems: 'flex-end', padding: 'clamp(72px,9vw,144px) clamp(24px,5vw,96px) 64px', color: 'var(--color-bone)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: 1320, margin: '0 auto', width: '100%' }}>
        <div className="numlabel" style={{ color: 'var(--color-gold-soft)', marginBottom: 20 }}><span>â€”</span>INVEST</div>
          ...
          <div style={{ padding: '40px 36px', background: 'var(--color-green)', color: 'var(--color-bone)' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, borderTop: '1px solid rgba(248,245,238,0.15)' }}>
              {[
                ...
                'Verified provenance â€” chain from soil to shelf',
    ...
    <section className="section-pad">
      <div className="container">
        ...
        <p style={{ marginTop: 16, fontSize: 12, color: 'var(--color-ink-mute)', letterSpacing: '0.06em' }}>
          Figures indicative Â· All crop prices based on confirmed 2025 actual season prices Â· Full model on memorandum request
        </p>
      </div>
    </section>
  );
    ...
    <section className="section-pad" style={{ background: 'var(--color-bone-deep)' }}>
      <div className="container">
        <div style={{ maxWidth: 720, marginBottom: 'clamp(40px,5vw,64px)' }}>
          ...
          <p className="lede" style={{ marginTop: 16 }}>Loan terms: R2,000,000 at Prime âˆ’ 2% (9.25% p.a.) Â· Quarterly instalments Â· 17 quarters Â· Fully repaid: April 2031</p>
        </div>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
...
function RoadmapSection() {
  const phases = [
    { num: 'Phase I', title: 'Foundation & Systems Integration', range: 'Months 00 â€” 08', items: ['Asset deployment: core production machinery and logistics', '4IR technology integration: IoT monitoring, automation, data analytics', 'Pilot production and validation: quality assurance protocols', 'Workforce upskilling: data-driven workflows, compliance standards'] },
    { num: 'Phase II', title: 'Expansion & Market Penetration', range: 'Months 09 â€” 18', items: ['Production scale-up: ~150% output increase', 'Value-added processing facility commissioned', 'B2B commercialisation: medium- to long-term supply contracts', 'Lean manufacturing and continuous improvement deployed'] },
    { num: 'Phase III', title: 'Profitability & Export Readiness', range: 'Months 19 â€” 24', items: ['Consistent positive operating margins achieved', 'Regulated-market certifications attained', 'Export contracts initiated with international buyers', 'Strategic brand positioning: data-backed quality claims'] },
  ];
...
function EmploymentSection() {
  const rows = [
    { cat: 'Permanent farm workers', y1: '6â€“8', y2: '10â€“12', y3plus: '12â€“15' },
    { cat: 'Tunnel / horticulture workers', y1: '1â€“2', y2: '2â€“3', y3plus: '3â€“4' },
    { cat: 'Seasonal â€” planting', y1: '4â€“6', y2: '6â€“8', y3plus: '8â€“10' },
    { cat: 'Seasonal â€” harvest', y1: '6â€“8', y2: '8â€“10', y3plus: '10â€“12' },
    { cat: 'Management / admin', y1: '1', y2: '2', y3plus: '2â€“3' },
    { cat: 'TOTAL (peak season)', y1: '18â€“25', y2: '26â€“35', y3plus: '33â€“44', total: true },
  ];
    ...
    <section className="section-pad">
      <div className="container">
        <div style={{ maxWidth: 720, marginBottom: 'clamp(40px,5vw,64px)' }}>
          ...
          <h2>18â€“25 jobs in Year 1. Growing to 44 by Year 3.</h2>
